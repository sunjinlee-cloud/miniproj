...
<body>
    ...
    <footer>
        <div class="underminimenu">
            ...
            <p>(주)모르는개산책 | 대표 박인욱 | 서울 강남구 테헤란로7길 7 (역삼동) 5층 | 대표 전화번호 : 010-1234-1234<br>
                사업자 등록 번호 : 123-45-67890 | <a href="https://www.animals.or.kr/">동물자유연대</a> | <a href="https://www.qia.go.kr/">동물자유연대</a></p>
        </div>
        <div class="infoarea">
            <p>Copyright 2025 Unknownpetwalk © All rights reserved.</p>
        </div>
    </footer>
</body>
</html>